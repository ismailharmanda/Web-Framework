...
function () {
  ...
  View.prototype.regionsMaps = function () {
    return {};
  };
  ...
  View.prototype.mapRegions = function (fragment) {
    var regionsMap = this.regionsMaps();
...
function () {
  function Eventing() {
    ...
    this.trigger = function (eventName) {
      var handlers = _this.events[eventName]; //Yukarıda kullandığım gibi de çalışır.
...
exports.ApiSync = exports.rootUrl = void 0;

var axios_1 = __importDefault(require("axios"));

var apiUrl = "http://localhost:3000";
exports.rootUrl = apiUrl + "/users";
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(ApiSync_1.rootUrl));
  };

  User.buildUserCollection = function () {
    return new Collection_1.Collection(ApiSync_1.rootUrl, function (json) {
...
var users = new Collection_1.Collection(ApiSync_1.rootUrl, function (json) {
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts","./models/ApiSync":"src/models/ApiSync.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13975" + '/');
