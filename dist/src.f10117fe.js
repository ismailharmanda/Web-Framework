...
function () {
  ...
  User.prototype.fetch = function () {
    ...
    axios_1.default.get(apiUrl + "/users/" + this.get("id")).then(function (response) {
      response.status === 200 && _this.set(response.data);
    }).catch(function (e) {
      console.log(e);
    });
  };
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1246" + '/');
